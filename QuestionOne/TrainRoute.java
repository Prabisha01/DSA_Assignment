package QuestionOne;
// cheapest route from a source node to a destination node in a directed graph,
// given a time constraint and a charge associated with each node. uses Dijkstra's algorithm to find the shortest path from
...
public class TrainRoute {
        static class Edge {
            ...
            Edge(int to, int time, int cost) {  //constructor
                this.to = to;
                this.time = time;
                this.cost = cost;
            }
