...
public class DependencyController {
    ...
    public String[] depArray(){
        String query = "select * from dependency where jobId = '" + Homepage.JOB_ID + "' and userId = '" + Login.USER_ID + "';";
        ...
        System.out.println(dependencies);
        String[] depArray=new String[dependencies.size()];
        for(int i=0;i<dependencies.size();i++){
            depArray[i]= dependencies.get(i);
        }
        return depArray;
    }
}
